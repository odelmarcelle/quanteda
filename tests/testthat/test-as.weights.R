...
test_that("check_font is working", {
    ...
    expect_identical(as.weights(c("a*" = 2), mt),
                     c(ABC = 2, abc = 2, AAA = 2, aaa = 2))
    expect_identical(as.weights(c("a*" = 2), mt, case_insensitive = FALSE),
                     c(abc = 2, aaa = 2))
    
    expect_identical(as.weights(c("a*" = 2), mt, nomatch_weight = 0),
                     c(ABC = 2, abc = 2, AAA = 2, aaa = 2, BBB = 0, bbb = 0, CC = 0, cc = 0))
    expect_identical(as.weights(c("a*" = 2), mt, case_insensitive = FALSE, nomatch_weight = 0),
